...
public class Menu {
	...
	private void initialize()  throws SQLException {
		...
		//Programación visual, definicion de: Labels, botones, backgrounds
		...
		btnSalir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) { // Cierra el programa
				frame.dispose();
			}
		});
		...
		// Unir las funciones con sus botones.
	...
	//Función para insertar nuevos elementos a la tabla
	...
	//Funcion para buscar elementos por nombre o por descripcion
	...
	//Funcion para modificar los datos de un elemento seleccionado
